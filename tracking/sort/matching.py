...
def iou(bbox, candidates):
    """Compute IoU by one box to N candidates
    Parameters
    ----------
...
def iou_cost(tracks, detections, track_indices=None, detection_indices=None):
    ...
    """
    if track_indices is None: track_indices = np.arange(len(tracks))
    if detection_indices is None: detection_indices = np.arange(len(detections))
